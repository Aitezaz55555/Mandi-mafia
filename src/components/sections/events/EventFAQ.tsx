...
import { eventFaqsList } from "@/lib/events-data";
    ...
    <section className="bg-obsidian border-t border-gold/10 py-16">
      <div className="max-w-3xl mx-auto px-space-4 space-y-12 select-text">
        ...
        <div className="text-center space-y-space-2">
          <span className="font-body text-[9px] uppercase tracking-[0.2em] text-gold/80 font-medium font-semibold block">Clear Answers</span>
          <h3 className="font-heading text-2xl md:text-3xl text-ivory">Frequently Asked Concerns</h3>
        </div>

        <div className="space-y-4">
          {eventFaqsList.map((faq, index) => {
